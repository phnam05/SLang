...
#             raise SLangRuntimeError(f"Expected int for '{var_name}', got {type(value).__name__}", ctx)
#         elif var_type == "float" and not isinstance(value, (int, float)):
#             raise SLangRuntimeError(f"Expected float for '{var_name}', got {type(value).__name__}", ctx)
#         elif var_type == "boolean" and not isinstance(value, bool):
#             raise SLangRuntimeError(f"Expected boolean for '{var_name}', got {type(value).__name__}", ctx)
#         elif var_type == "string" and not isinstance(value, str):
#             raise SLangRuntimeError(f"Expected string for '{var_name}', got {type(value).__name__}", ctx)
#         elif var_type == "array" and not isinstance(value, list):
#             raise SLangRuntimeError(f"Expected array for '{var_name}', got {type(value).__name__}", ctx)
#
...
#                 raise SLangRuntimeError("Array index must be an integer", ctx)
...
#                 raise SLangRuntimeError(f"{var_name} is not an array", ctx)
#             if index < 0 or index >= len(self.variables[var_name]):
#                 raise SLangRuntimeError("Array index out of bounds", ctx)
#             self.variables[var_name][index] = value
#         else:
#             if var_name not in self.variables:
#                 raise SLangRuntimeError(f"Variable '{var_name}' not declared", ctx)
#             self.variables[var_name] = value
#
...
#             raise SLangRuntimeError("If condition must be boolean", ctx)
#         if condition:
...
#             raise SLangRuntimeError("For loop must iterate over an array", ctx)
#         for value in array:
#             self.variables[var_name] = value
...
#             if not isinstance(condition, bool):
#                 raise SLangRuntimeError("Ternary condition must be boolean", ctx)
...
#                 raise SLangRuntimeError("Logical OR requires boolean operands", ctx)
...
#             if not (isinstance(result, bool) and isinstance(right, bool)):
#                 raise SLangRuntimeError("Logical AND requires boolean operands", ctx)
...
#             if op == "/":
#                 if right == 0:
#                     raise SLangRuntimeError("Division by Zero", ctx)
#                 result = result / right
#             elif op == "*":
#                 result = result * right
#             elif op == "%":
...
#                 raise SLangRuntimeError("Logical NOT requires boolean operand", ctx)
#             return not value
#
...
#                 if not isinstance(index, int):
#                     raise SLangRuntimeError("Array index must be integer", ctx)
...
#             raise SLangRuntimeError("Function calls not supported", ctx)
...
#         # Handle or log error however you want — no print here either if unneeded
